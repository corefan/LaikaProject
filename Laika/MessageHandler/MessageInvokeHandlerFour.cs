...
namespace Laika.MessageHandler
{
    ...
    public class MessageInvokeHandler<MA1, MA2, MA3, MA4, MR>
    {
        /// <summary>
            ...
            where LC : class, new()
        {
            ...
            foreach (MethodInfo m in methods)
            {
                ...
                Func<MA1, MA2, MA3, MA4, MR> executeableMethod = null;
                if (m.IsStatic == true)
                {
        ...
        private Func<MA1, MA2, MA3, MA4, MR> GetDelegate(MethodInfo m)
        {
            return (Func<MA1, MA2, MA3, MA4, MR>)Delegate.CreateDelegate(typeof(Func<MA1, MA2, MA3, MA4, MR>), m);
        }

        private Func<MA1, MA2, MA3, MA4, MR> GetDelegate<LC>(MethodInfo m, LC instance)
        {
            return (Func<MA1, MA2, MA3, MA4, MR>)Delegate.CreateDelegate(typeof(Func<MA1, MA2, MA3, MA4, MR>), instance, m);
        }

        private void Add(int type, Func<MA1, MA2, MA3, MA4, MR> func)
        {
        ...
        public MR InvokeMethod(int type, MA1 arg1, MA2 arg2, MA3 arg3, MA4 arg4)
        {
            if (_messageMap.ContainsKey(type) == false)
                throw new KeyNotFoundException();

            return _messageMap[type](arg1, arg2, arg3, arg4);
        }
        ...
        /// <param name="arg1">메소드에 넘겨줄 arg1</param>
        /// <returns>메소드 실행 후 return 되는 타입</returns>
        public Task<MR> InvokeMethodAsync(int type, MA1 arg1, MA2 arg2, MA3 arg3, MA4 arg4)
        {
            if (_messageMap.ContainsKey(type) == false)
                throw new KeyNotFoundException();

            Task<MR> task = new Task<MR>(() => { return _messageMap[type](arg1, arg2, arg3, arg4); });
            task.Start();
            return task;
        }

        private Dictionary<int, Func<MA1, MA2, MA3, MA4, MR>> _messageMap = new Dictionary<int, Func<MA1, MA2, MA3, MA4, MR>>();
    }
}
